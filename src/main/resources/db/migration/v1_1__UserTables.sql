ALTER TABLE organization MODIFY COLUMN EMAIL VARCHAR(50) NOT NULL;
ALTER TABLE organization MODIFY COLUMN FACEBOOK VARCHAR(50);
ALTER TABLE organization MODIFY COLUMN TWITTER VARCHAR(50);
ALTER TABLE organization MODIFY COLUMN INSTAGRAM VARCHAR(50);
