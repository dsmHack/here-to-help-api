insert into organization (organization_guid,name,description,phone_number,email,website_url,facebook_url,twitter_url,instagram_url,address1,city,state,zip)
