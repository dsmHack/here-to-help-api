insert into organization (org_guid,name,description,phone_number,email,website_url,facebook_url,twitter_url,instagram_url,address1,city,state,zip)
...
insert into user (user_guid,first_name,last_name,email,role) values ('c8493c34-2f0f-11e8-b467-0ed5f89f718b','Amanda','Panda','anthonybrobston@gmail.com','ROLE_DSMHACK_ADMINISTRATOR');
