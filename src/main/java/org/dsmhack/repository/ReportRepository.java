...
public class ReportRepository {
    ...
    public List<ReportData> findAllReportingInformation(String organizationId) {
        String sql =
            "select project.proj_guid as projectGuid, project.name as projectName, user.user_guid as userGuid, user.first_name as firstName, user.last_name as lastName, check_in.time_in as timeIn, check_in.time_out as timeOut " +
